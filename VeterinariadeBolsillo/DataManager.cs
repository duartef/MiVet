	...
	public class DataManager
	{
		...
		public void CreateDatabase (string sqldb_name)
		{
			try
			{
				...
				if (!sqldb_exists)
				{
                    conn.CreateTable(typeof(lPersona), CreateFlags.None);
                    conn.CreateTable(typeof(lVeterinaria), CreateFlags.None);
                    conn.CreateTable(typeof(lVisita), CreateFlags.None);
                    conn.CreateTable(typeof(lAnimal), CreateFlags.None);
                    conn.CreateTable(typeof(lMascota), CreateFlags.None);
        ...
        private lVisita lVisitaFromVisita(Visita visita)
        {
            try
            {
                ...
                x.ComentariosInternos = visita.ComentariosInternos;
